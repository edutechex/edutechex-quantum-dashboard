...
export class AddOrEditTeamComponent implements OnInit{
  ...
  constructor(
    ...
    private dialogRef : MatDialogRef<AddOrEditTeamComponent>,
  ...
  addeditTeamItem(){
    if(this.addEditTeamItemForm.valid){
      if(this.datas){
        ...
        this.editTeamItem(editTeamData)
      }else{
        ...
        this.addTeamItem(addTeamData);
      }
    }
  }
  addTeamItem(data: any){
